...
public class EDQLTimeoutExprImpl extends ASTWrapperPsiElement implements EDQLTimeoutExpr {

  public EDQLTimeoutExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EDQLVisitor visitor) {
    visitor.visitTimeoutExpr(this);
  }
