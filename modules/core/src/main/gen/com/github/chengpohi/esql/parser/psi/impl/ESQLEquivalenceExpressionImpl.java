...
public class ESQLEquivalenceExpressionImpl extends ESQLExpressionImpl implements ESQLEquivalenceExpression {

  public ESQLEquivalenceExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
