...
public class ESQLCompoundOperatorImpl extends ASTWrapperPsiElement implements ESQLCompoundOperator {

  public ESQLCompoundOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
