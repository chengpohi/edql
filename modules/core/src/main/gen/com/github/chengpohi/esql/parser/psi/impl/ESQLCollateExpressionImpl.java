...
public class ESQLCollateExpressionImpl extends ESQLExpressionImpl implements ESQLCollateExpression {

  public ESQLCollateExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ESQLCollationName getCollationName() {
    return findNotNullChildByClass(ESQLCollationName.class);
  }
