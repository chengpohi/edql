...
public class ESQLCastExpressionImpl extends ESQLExpressionImpl implements ESQLCastExpression {

  public ESQLCastExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public ESQLTypeName getTypeName() {
    return findChildByClass(ESQLTypeName.class);
  }
