...
public class ESQLSelectCoreValuesImpl extends ASTWrapperPsiElement implements ESQLSelectCoreValues {

  public ESQLSelectCoreValuesImpl(@NotNull ASTNode node) {
    super(node);
  }
