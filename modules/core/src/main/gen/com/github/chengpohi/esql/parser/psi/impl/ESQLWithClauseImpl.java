...
public class ESQLWithClauseImpl extends ASTWrapperPsiElement implements ESQLWithClause {

  public ESQLWithClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<ESQLWithClauseTable> getWithClauseTableList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, ESQLWithClauseTable.class);
  }
