...
public class EDQLHostExprImpl extends ASTWrapperPsiElement implements EDQLHostExpr {

  public EDQLHostExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EDQLVisitor visitor) {
    visitor.visitHostExpr(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getHostPath() {
    return findNotNullChildByType(HOST_PATH);
  }
