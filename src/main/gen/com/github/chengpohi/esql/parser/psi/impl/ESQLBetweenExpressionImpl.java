...
public class ESQLBetweenExpressionImpl extends ESQLExpressionImpl implements ESQLBetweenExpression {

  public ESQLBetweenExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
