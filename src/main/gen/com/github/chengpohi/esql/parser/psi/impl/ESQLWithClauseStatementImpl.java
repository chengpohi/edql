...
public class ESQLWithClauseStatementImpl extends ASTWrapperPsiElement implements ESQLWithClauseStatement {

  public ESQLWithClauseStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
