...
public class ESQLFunctionCallExpressionImpl extends ESQLExpressionImpl implements ESQLFunctionCallExpression {

  public ESQLFunctionCallExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ESQLFunctionName getFunctionName() {
    return findNotNullChildByClass(ESQLFunctionName.class);
  }
