...
public class ESQLWithClauseTableImpl extends ASTWrapperPsiElement implements ESQLWithClauseTable {

  public ESQLWithClauseTableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public ESQLWithClauseTableDef getWithClauseTableDef() {
    return findNotNullChildByClass(ESQLWithClauseTableDef.class);
  }
