...
public class ESQLFromTableImpl extends ASTWrapperPsiElement implements ESQLFromTable {

  public ESQLFromTableImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public ESQLDefinedTableName getDefinedTableName() {
    return findNotNullChildByClass(ESQLDefinedTableName.class);
  }
