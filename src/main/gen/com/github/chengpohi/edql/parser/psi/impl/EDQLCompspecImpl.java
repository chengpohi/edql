...
public class EDQLCompspecImpl extends ASTWrapperPsiElement implements EDQLCompspec {

  public EDQLCompspecImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EDQLIfspec> getIfspecList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EDQLIfspec.class);
  }
