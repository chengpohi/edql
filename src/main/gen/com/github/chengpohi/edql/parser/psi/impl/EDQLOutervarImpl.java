...
public class EDQLOutervarImpl extends ASTWrapperPsiElement implements EDQLOutervar {

  public EDQLOutervarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EDQLVisitor visitor) {
    visitor.visitOutervar(this);
  }
  ...
  @Override
  @NotNull
  public EDQLBind getBind() {
    return findNotNullChildByClass(EDQLBind.class);
  }
