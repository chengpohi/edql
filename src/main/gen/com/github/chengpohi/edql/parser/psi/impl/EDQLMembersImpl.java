...
public class EDQLMembersImpl extends ASTWrapperPsiElement implements EDQLMembers {

  public EDQLMembersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EDQLMember> getMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EDQLMember.class);
  }
