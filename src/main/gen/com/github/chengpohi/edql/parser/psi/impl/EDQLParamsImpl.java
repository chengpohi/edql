...
public class EDQLParamsImpl extends ASTWrapperPsiElement implements EDQLParams {

  public EDQLParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EDQLParam> getParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EDQLParam.class);
  }
