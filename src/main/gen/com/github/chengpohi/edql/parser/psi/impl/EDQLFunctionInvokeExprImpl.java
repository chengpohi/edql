...
public class EDQLFunctionInvokeExprImpl extends ASTWrapperPsiElement implements EDQLFunctionInvokeExpr {

  public EDQLFunctionInvokeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EDQLVisitor visitor) {
    visitor.visitFunctionInvokeExpr(this);
  }
